  ...
  return (
    <div className="flex h-full flex-col space-x-0 space-y-4 bg-gradient-to-b from-contrast from-90% to-contrast-alt px-6 md:px-20 lg:space-x-20 lg:px-40">
      ...
      <Accordion>
        ...
        >
          Yes, we offer personalized plans to meet your specific needs. If you're interested, please
          send an email to{" "}
        ...
        >
          ...
          <UnderlineLink href="/tracker">Tracker</UnderlineLink> page and enter the product's URL in
          the designated field. If you have reached the limit of products being tracked
        ...
        >
          ...
          remove any product from your wishlist at any time by clicking the three vertical dots, 🗑️
          Delete option.
        </AccordionItem>
        ...
        >
          If you face any issues with tracking specific products, please check the compatibility of
          the site. If the issue persists, contact our support for further assistance at{" "}
          <UnderlineLink href="mailto:shoptracker.contact@gmail.com">
            shoptracker.contact@gmail.com
          </UnderlineLink>
          .
