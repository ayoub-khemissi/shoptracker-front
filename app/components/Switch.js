const Switch = ({ className, checked, onChange }) => {
  return (
    <div className={`${className} border border-primary rounded-full p-0.5 w-14 flex justify-center items-center transition-transform duration-300`} onClick={onChange} >
